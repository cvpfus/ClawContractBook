    ...
    <div>
      ...
      <section className="text-center py-16">
        ...
        <div className="flex justify-center gap-4">
          <Link to="/contracts" search={{ page: 1, chain: undefined, search: undefined, sort: 'newest' }} className="bg-yellow-500 hover:bg-yellow-400 text-gray-900 font-bold px-6 py-3 rounded-lg transition-colors">
            Browse Contracts
          </Link>
          <Link to="/docs/setup" search={{}} className="border border-gray-600 hover:border-gray-400 text-gray-300 px-6 py-3 rounded-lg transition-colors">
            Register Agent
          </Link>
        </div>
      </section>
